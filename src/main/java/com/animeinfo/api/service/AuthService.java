...
import com.animeinfo.api.config.Constante;
...
import com.animeinfo.api.exception.ApiMessageCode;
import com.animeinfo.api.exception.BusinessException;
import com.animeinfo.api.security.KeyToken;
import com.animeinfo.api.security.TokenBuilder.*;
import com.animeinfo.api.security.TokenBuilder;
import com.animeinfo.api.util.Util;
...
public class AuthService {
    ...
    public CredencialDTO registerUser(CredencialRegisterDTO credencialRegisterDTO) {
        return userProviderService.register(credencialRegisterDTO);
    }
}